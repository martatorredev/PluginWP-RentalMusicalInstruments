 ...
 * Plantilla Vista del PAGO POR EL alquiler del producto, despues del checkout o pagina de FACTURAR.
 * si el pago es EXITOSO O APROBADO, crea y guarda el plan de pagos futuros del alquiler y marca la orden como "COMPLETADA" (o pagada). 
 * File: html-wcai-order-pay-page.php
 */

 defined( 'ABSPATH' ) || exit;

 global $woocommerce, $meses_alquiler, $wcai_date_from, $wcai_date_to, $nombre_producto_alquiler ;
 global $wcai_id_product, $wcai_nro_orden, $wcai_total_alquiler, $wcai_nombre_producto_alquiler;  
// echo '<BR><BR>ESTOY EN HTML-wcai-order-pay_page.php CON wcai_id_product = '.$wcai_id_product.' CON wcai_nro_orden = '.$wcai_nro_orden.' CON wcai_date_from = '.$wcai_date_from.'<br><br>';
// echo 'CON wcai_date_TO = '.$wcai_date_to.' CON wcai_total_alquiler = '.$wcai_total_alquiler.' CON wcai_nombre_producto_alquiler = '.$wcai_nombre_producto_alquiler.'<br><br>';
